...
class CreateNteNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nte_notes', function (Blueprint $table) {
            $table->id();
            ...
            // $table->foreign('parent_id')->references('id')->on('nte_notes')->onDelete('cascade');
        });
    }
