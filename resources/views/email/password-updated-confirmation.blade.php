                            ...
                            <td colspan="2" style="padding: 20px; background-color: #ededed;">
                               <h3 style="text-align:text-center !important;">{{$full_name}}'s password changed</h3>
                                ...
                                <p>
                                    ...
                                    We take your security very seriously and want to keep you in the loop on important actions with this account. If you don't changed your password, you can always change it again in this <strong><a href="https://maxtel.intra-code.com/forget-password">Link</a></strong>.
                                </p>
                                    <br>
