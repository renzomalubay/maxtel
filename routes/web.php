...
// Management Overview - Multiple routes with same functionality to prevent dashboard redirect
Route::get('management-overview', [SummaryController::class, 'index'])->middleware(['auth'])->name('management_overview');
Route::get('management-dashboard', [SummaryController::class, 'index'])->middleware(['auth'])->name('management_dashboard');
Route::get('summary', [SummaryController::class, 'index'])->middleware(['auth'])->name('summary');
// Management Summary AJAX endpoints
Route::get('get-all-employees', [SummaryController::class, 'getAllEmployees'])->middleware(['auth'])->name('get_all_employees');
Route::get('get-employee-summary', [SummaryController::class, 'getEmployeeSummary'])->middleware(['auth'])->name('get_employee_summary');
Route::post('get-employee-records', [SummaryController::class, 'getEmployeeRecords'])->middleware(['auth'])->name('get_employee_records');
Route::post('get-record-details', [SummaryController::class, 'getRecordDetails'])->middleware(['auth'])->name('get_record_details');
Route::get('export-employee-summary', [SummaryController::class, 'exportEmployeeSummary'])->middleware(['auth'])->name('export_employee_summary');
    ...
    Route::post('get-employee-management-records-count', [dashboardController::class, 'getEmployeeManagementRecordsCount'])->middleware(['auth'])->name('get_employee_management_records_count');
    Route::post('get-approvals-count', [dashboardController::class, 'getApprovalsCount'])->middleware(['auth'])->name('get_approvals_count');
    Route::post('get-employees-by-status', [dashboardController::class, 'getEmployeesByStatus'])->middleware(['auth'])->name('get_employees_by_status');
...
Route::get('report_management', [reportController::class, 'report_management'])->middleware(['auth'])->name('report_management');
    ...
    Route::get('exportPayrollReport/{payid}', [reportController::class, 'exportPayrollReport'])->middleware(['auth'])->name('exportPayrollReport');
     //bank report
    Route::get('exportBankReport/{payid}', [reportController::class, 'exportBankReport'])->middleware(['auth'])->name('exportBankReport');
     //export pdf
    Route::get('exportPayrollPDF/{payid}', [reportController::class, 'exportPayrollReportPDF'])->middleware(['auth'])->name('exportPayrollPDF');
    ...
    Route::get('export_tc/{payid}', [reportController::class, 'export_tc'])->middleware(['auth'])->name('export_tc');
    Route::get('exportLoanBalances/{emp_id}/{as_of_date}', [reportController::class, 'exportLoanBalances'])->middleware(['auth'])->name('exportLoanBalances');
    Route::get('exportSalaryExpenses/{date_from}/{date_to}', [reportController::class, 'exportSalaryExpenses'])->middleware(['auth'])->name('exportSalaryExpenses');
...
Route::get('timekeeping_management', [timekeepingController::class, 'timekeeping_management'])->middleware(['auth'])->name('timekeeping_management');
    ...
    Route::get('export_raw_logs', [timekeepingController::class, 'exportRawLogs'])->middleware(['auth'])->name('export_raw_logs');
    ...
    Route::post('manual_in_out_request', [timekeepingController::class, 'manual_in_out_request'])->middleware(['auth'])->name('manual_in_out_request');
    
    Route::get('/get-employees-by-branch', [timekeepingController::class, 'getEmployeesByBranch'])->middleware(['auth'])->name('get-employees-by-branch');
    Route::post('timecard_logs_tbl_new', [timekeepingController::class, 'timecard_logs_tbl_new'])->middleware(['auth'])->name('timecard_logs_tbl_new');
    Route::post('/manual-in-out-inline', [timekeepingController::class, 'manual_in_out_inline'])->middleware(['auth'])->name('manual_in_out_inline');
    Route::post('/manual-update-schedule', [timekeepingController::class, 'manualUpdateSchedule'])->middleware(['auth'])->name('manual_update_schedule');
    ...
    Route::post('delete_manual_log', [timekeepingController::class, 'delete_manual_log'])->middleware(['auth'])->name('delete_manual_log');
    // Delete function for Holiday
    Route::post('delete_holiday', [timekeepingController::class, 'delete_holiday'])->middleware(['auth'])->name('delete_holiday');
    
    Route::post('sched_req_tbl', [timekeepingController::class, 'sched_req_tbl'])->middleware(['auth'])->name('sched_req_tbl');
    Route::post('req_sched_action', [timekeepingController::class, 'req_sched_action'])->middleware(['auth'])->name('req_sched_action');
    Route::post('req_sched_add', [timekeepingController::class, 'req_sched_add'])->middleware(['auth'])->name('req_sched_add');
...
Route::get('leave_management', [leaveController::class, 'leave_management'])->middleware(['auth'])->name('leave_management');
    ...
    Route::get('get_leaves/{month_view}/{page}', [leaveController::class, 'get_leaves'])->middleware(['auth'])->name('get_leaves');
...
Route::get('income_management', [othIncomeController::class, 'income_management'])->middleware(['auth'])->name('income_management');
    ...
    Route::post('get_employee_list', [othIncomeController::class, 'get_employee_list'])->middleware(['auth'])->name('get_employee_list');
    Route::post('allowance_request_tbl', [othIncomeController::class, 'allowance_request_tbl'])->middleware(['auth'])->name('allowance_request_tbl');
    Route::post('save_allowance_request', [othIncomeController::class, 'save_allowance_request'])->middleware(['auth'])->name('save_allowance_request');
    Route::post('delete_allowance', [othIncomeController::class, 'delete_allowance'])->middleware(['auth'])->name('delete_allowance');
...
Route::get('schedule_management', [scheduleController::class, 'schedule_management'])->middleware(['auth'])->name('schedule_management');
    ...
    Route::post('get_employee_schedule', [scheduleController::class, 'getEmployeeSchedule'])->middleware(['auth'])->name('get_employee_schedule');
Route::get('employees_management', [employeeController::class, 'employees_management'])->middleware(['auth'])->name('employees_management');
    ...
    Route::get('employee/export', [employeeController::class, 'export'])->middleware(['auth'])->name('employee.export');
    ...
    Route::get('/nte-note/{id}', [NteController::class, 'show'])->middleware(['auth'])->name('nte.show');
    Route::post('/nte/store', [NteController::class, 'store'])->middleware(['auth'])->name('nte.store');
    Route::put('/nte/update/{id}', [NteController::class, 'update'])->middleware(['auth'])->name('nte.update');
    Route::post('/nte/reply', [NteController::class, 'reply'])->middleware(['auth'])->name('nte.reply');
    Route::delete('/nte/delete/{id}', [NteController::class, 'delete'])->middleware(['auth'])->name('nte.delete');
    Route::post('/nte/export', [NteController::class, 'export'])->middleware(['auth'])->name('nte.export');
    //performance improvement management
    Route::get('/performance_improvement', [PerformanceImprovementController::class, 'index'])->middleware(['auth'])->name('performance_improvement');
    Route::post('/performance_improvement/store', [PerformanceImprovementController::class, 'store'])->middleware(['auth'])->name('performance_improvement.store');
    Route::post('/performance_improvement/reply', [PerformanceImprovementController::class, 'reply'])->middleware(['auth'])->name('performance_improvement.reply');
    Route::delete('/performance_improvement/delete/{id}', [PerformanceImprovementController::class, 'delete'])->middleware(['auth'])->name('performance_improvement.delete');
    Route::post('/performance_improvement/export', [PerformanceImprovementController::class, 'export'])->middleware(['auth'])->name('performance_improvement.export');
   //Diciplinary management
   Route::get('disciplinary', [DisciplinaryController::class, 'index'])->middleware(['auth'])->name('disciplinary');
   Route::post('disciplinary/store', [DisciplinaryController::class, 'store'])->middleware(['auth'])->name('disciplinary.store');
   Route::delete('disciplinary/{id}', [DisciplinaryController::class, 'delete'])->middleware(['auth'])->name('disciplinary.delete');
   Route::post('disciplinary/export', [DisciplinaryController::class, 'export'])->middleware(['auth'])->name('disciplinary.export');
   //Accountabilities
   // Route::post('add_accountabilities_permission', [EmployeeBankController::class, 'addAccountabilitiesPermission'])->middleware(['auth'])->name('add_accountabilities_permission');
// Route::post('remove_accountabilities_permission', [EmployeeBankController::class, 'removeAccountabilitiesPermission'])->middleware(['auth'])->name('remove_accountabilities_permission');
// List of Accountabilities Routes
Route::get('list_of_accountabilities', [AccountabilitiesController::class, 'index'])->middleware(['auth'])->name('list_of_accountabilities');
Route::get('my_accountabilities', [AccountabilitiesController::class, 'staffView'])->middleware(['auth'])->name('my_accountabilities');
Route::post('accountabilities_list', [AccountabilitiesController::class, 'list'])->middleware(['auth'])->name('accountabilities_list');
Route::post('create_accountabilities_table', [AccountabilitiesController::class, 'createTable'])->middleware(['auth'])->name('create_accountabilities_table');
Route::post('export_accountabilities', [AccountabilitiesController::class, 'exportTable'])->middleware(['auth'])->name('export_accountabilities');
Route::post('accountabilities/export', [AccountabilitiesController::class, 'export'])->middleware(['auth'])->name('accountabilities.export');
Route::get('get_employees', [AccountabilitiesController::class, 'getEmployees'])->middleware(['auth'])->name('get_employees');
Route::post('store_accountability', [AccountabilitiesController::class, 'store'])->middleware(['auth'])->name('store_accountability');
Route::get('get_accountability/{id}', [AccountabilitiesController::class, 'show'])->middleware(['auth'])->name('get_accountability');
Route::put('update_accountability/{id}', [AccountabilitiesController::class, 'update'])->middleware(['auth'])->name('update_accountability');
Route::delete('delete_accountability/{id}', [AccountabilitiesController::class, 'destroy'])->middleware(['auth'])->name('delete_accountability');
//Personnel Action Form
Route::get('personnel_action_form', [PersonnelActionController::class, 'index'])->middleware(['auth'])->name('personnel_action_form');
Route::post('personnel_action/store', [PersonnelActionController::class, 'store'])->middleware(['auth'])->name('personnel_action.store');
Route::post('personnel_action/update', [PersonnelActionController::class, 'updateAction'])->middleware(['auth'])->name('personnel_action.update');
Route::post('get_employee_data', [PersonnelActionController::class, 'getEmployeeData'])->middleware(['auth'])->name('get_employee_data');
Route::post('get_employee_schedule', [PersonnelActionController::class, 'getScheduleList'])->middleware(['auth'])->name('get_employee_schedule');
Route::post('get_personnel_action_details', [PersonnelActionController::class, 'getActionDetails'])->middleware(['auth'])->name('get_personnel_action_details');
Route::post('delete_personnel_action', [PersonnelActionController::class, 'deleteAction'])->middleware(['auth'])->name('delete_personnel_action');
...
Route::delete('incident-report/{id}', [IncidentReportController::class, 'destroy'])->middleware(['auth'])->name('incident-report.destroy');
Route::post('delete_incident_report', [IncidentReportController::class, 'destroy'])->middleware(['auth'])->name('delete_incident_report');
...
Route::post('unlisted_locations/mark-as-listed', [UnlistedLocationsController::class, 'markAsListed'])->middleware(['auth'])->name('mark_as_listed');
